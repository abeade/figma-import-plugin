...
class ImportConfirmationDialogWrapper(
    private val resource: String,
    private val affectedDensities: MutableList<String>
) : DialogWrapper(true) {
    ...
    override fun createCenterPanel(): JComponent = ImportConfirmationDialog().apply {
